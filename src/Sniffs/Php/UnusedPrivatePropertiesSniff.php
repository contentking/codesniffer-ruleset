...
class UnusedPrivatePropertiesSniff implements PHP_CodeSniffer\Sniffs\Sniff
{
	...
	public function process(PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
	{
		...
		if ($isUnused) {
			if ($isStatic) {
				$phpcsFile->addError(sprintf('Found unused private static property \'%s\'. You should remove it.', $propertyName), $stackPtr, 'code');
			} else {
				$phpcsFile->addError(sprintf('Found unused private property \'$%s\'. You should remove it.', $propertyName), $stackPtr, 'code');
			}
		}
	}
